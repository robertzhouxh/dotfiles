...
;  (add-to-list 'eglot-server-programs '(erlang-mode . ("~/githubs/erlang_ls/_build/default/bin/erlang_ls")))
...
(use-package nox
  ...
  (add-to-list 'nox-server-programs '(erlang-mode . ("~/githubs/erlang_ls/_build/default/bin/erlang_ls")))
