...
(use-package dashboard
  ...
  (dashboard-startup-banner (expand-file-name "vendor/KEC_Dark_BK_Small.png" user-emacs-directory))
  ...
  (dashboard-navigator-buttons
   (if (featurep 'all-the-icons)
       `(((,(all-the-icons-octicon "mark-github" :height 1.1 :v-adjust -0.05) "M-EMACS" "Browse M-EMACS Homepage" (lambda (&rest _) (browse-url "https://github.com/robertzhouxh/.emacs.d")))
          (,(all-the-icons-faicon "cogs" :height 1.0 :v-adjust -0.1) "Configuration" "" (lambda (&rest _) (edit-configs)))
          (,(all-the-icons-faicon "cogs" :height 1.0 :v-adjust -0.1) "Update" "" (lambda (&rest _) (auto-package-update-now)))))
       `((("" "M-EMACS" "Browse M-EMACS Homepage" (lambda (&rest _) (browse-url "https://github.com/robertzhouxh/dotfiles")))
          ("" "Configuration" "" (lambda (&rest _) (edit-configs)))
          ("" "Update" "" (lambda (&rest _) (edit-configs)))))))
  :custom-face
