...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (one-key-create-menu
   ...
   '(
     ...
     (("z" . "中光睿华") . (lambda () (interactive) (eaf-open-in-file-manager "~/githubs/zgrh")))
     (("j" . "九天创新") . (lambda () (interactive) (eaf-open-in-file-manager "~/githubs/jt")))
     (("g" . "广联达") . (lambda () (interactive) (eaf-open-in-file-manager "~/githubs/gld")))
     )
   t)
