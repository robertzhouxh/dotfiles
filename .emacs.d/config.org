...
(use-package plantuml-mode
  ...
  (setq plantuml-jar-path "/usr/local/Cellar/plantuml/1.2020.6/libexec/plantuml.jar"))
(setq org-plantuml-jar-path "/usr/local/Cellar/plantuml/1.2020.6/libexec/plantuml.jar")
(setq plantuml-default-exec-mode 'jar)
;; optical config
