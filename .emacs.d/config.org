...
(defun load-font-setup()
  (cond ((eq window-system 'pgtk)
         (set-face-attribute 'default nil :height 160 :family "WenQuanYi Micro Hei Mono"))
        (t
         (let ((emacs-font-size 16)
           ...
           (set-face-attribute 'default nil :height 160 :family (eval english-font-name))
           (set-face-attribute 'default nil :height 160 :family (eval chinese-font-name))
