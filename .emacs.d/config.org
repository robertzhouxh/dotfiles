...
(use-package protobuf-mode :hook (after-init . protobuf-mode))
(use-package json-mode :hook (after-init . json-mode))
(use-package sh-script :hook (after-init . sh-mode))
(use-package yaml-mode :hook (after-init . yaml-mode))
;;(use-package plantuml-mode :hook (after-init . plantuml-mode))
