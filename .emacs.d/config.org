...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (global-set-key (kbd "C-x d") (lambda () (interactive) (eaf-open-in-file-manager (pwd))))
  ;(global-set-key (kbd "C-x d") (lambda () (interactive) (eaf-open-in-file-manager (file-name-directory (buffer-file-name)))))
