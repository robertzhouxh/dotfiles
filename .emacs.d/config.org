...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  ;; overwrites the original value of tramp-password-prompt-regexp,
  ;; which has a bunch of localized variants of “password” in it.
  ;; You can view the original value with C-h v tramp-password-prompt-regexp.
  (use-package tramp
    :ensure nil
    :custom
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (one-key-create-menu
   ...
   '(
     ...
     (("j" . "Picture") . (lambda () (interactive) (eaf-open-in-file-manager "~/Pictures")))
     (("g" . "Githubs") . (lambda () (interactive) (eaf-open-in-file-manager "~/githubs")))
