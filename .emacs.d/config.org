...
(setq eaf-browser-aria2-proxy-port "8123")
...
;;; EAF
(global-set-key (kbd "M-j")   'eaf-open-in-file-manager)
(global-set-key (kbd "s-'")   'eaf-open)
(global-set-key (kbd "s-\"")  'eaf-open-browser)
(global-set-key (kbd "s-n")   'eaf-open-terminal)
