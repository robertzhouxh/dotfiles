...
#+begin_src emacs-lisp :tangle yes
  ...
  ;(when (display-graphic-p) ((scroll-bar-mode -1)));禁用滚动条
...
(defun x/config-evil-leader ()
  ...
  (evil-leader/set-key
    ...
    ;; dired
    ;;"dc" '(lambda () (interactive) (eaf-open-in-file-manager (file-name-directory (buffer-file-name))))
    ;;"ds" '(lambda () (interactive) (eaf-open-in-file-manager "~/src"))
